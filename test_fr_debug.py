...
async def debug_fr_save():
    """FR 크롤러 저장 로직 디버깅"""
    print("="*60)
    print("FR Crawler Save Logic Debug")
    print("="*60)
    ...
    try:
        ...
        try:
            # 간단한 테스트 데이터 생성
            test_data = [{
                "title": "Test Medical Equipment Procurement",
                "organization": "Test French Hospital",
                "bid_number": "FR-TEST-001",
                "announcement_date": "2025-01-01",
                "deadline_date": "2025-02-01",
                "estimated_price": "100000",
                "currency": "EUR",
                "source_url": "https://test.fr/test",
        ...
        try:
            ...
            if 'site_breakdown' in stats:
                fr_count = stats['site_breakdown'].get('FR_BOAMP', 0)
                print(f"   FR_BOAMP records: {fr_count}")
        except Exception as e:
    ...
    print(f"\n" + "="*60)
    print("FR Debug Complete")

if __name__ == "__main__":
    asyncio.run(debug_fr_save())